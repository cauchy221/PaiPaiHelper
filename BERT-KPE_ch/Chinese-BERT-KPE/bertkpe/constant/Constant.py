...
dataset_class = "163_chinese_news"                      # dataset name
raw_train_data_path = "/content/drive/MyDrive/paipai-NLP/BERT-KPE_ch/data/163_chinese_news_dataset_2011/preprocessed_163_train.json"                # the path to your raw training data
raw_test_data_path = "/content/drive/MyDrive/paipai-NLP/BERT-KPE_ch/data/163_chinese_news_dataset_2011/preprocessed_163_test.json"                 # the path to your raw testing data
base_folder = "/content/drive/MyDrive/paipai-NLP/BERT-KPE_ch"                        # the path to the base working folder of this implementation, where all the results will be saved
general_pretrained_model_path = "/content/drive/MyDrive/paipai-NLP/BERT-KPE_ch/Chinese-BERT-KPE"
